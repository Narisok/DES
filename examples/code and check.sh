...
echo "Check:" $(time echo $1 | openssl des-ecb -K 1234567812345678 | ./Build/Examples/utility -d)
echo "Check:" $(time echo $1 | ./Build/Examples/utility | openssl des-ecb -d -K 1234567812345678)